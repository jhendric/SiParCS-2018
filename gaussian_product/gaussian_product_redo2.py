...
class gaussian_product:
    ...
    def __init__(self, window, grid_col, grid_row):
        ...
        self.main_frame.grid(column = grid_col, row = grid_row, sticky = "N, S, E, W") #may need to add sticky parameter
        ...
        self.prior_frame = ttk.Frame(self.main_frame, padding = "2", style = "Prior.TFrame") #may need to change padding
        ...
        self.prior_mean_entry = ttk.Entry(self.prior_frame, width = 5, textvariable = self.prior_mean
                                          ...
                                          style = "My.TEntry") #may need to change padding
        ...
        self.ob_frame = ttk.Frame(self.main_frame, padding = "2", style = "Ob.TFrame") #may need to change padding
        ...
        self.post_frame = ttk.Frame(self.main_frame, padding = "2", style = "Post.TFrame") #may need to change padding
        self.post_frame.grid(column = 2, row = 4, sticky = "N, S, E, W")


        self.style.configure("Post.TLabel", background = "Blue", foreground = "White")
        ttk.Label(self.post_frame, text = "Posterior", style = "Post.TLabel").grid(column = 1, row = 1, sticky = "N, S, E, W") #Will need to change font size
