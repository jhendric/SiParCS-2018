...
class ResizableWindow(ttk.Frame):
    def __init__(self, parent, *args, **kwargs):
        self.parent = parent
        self.f1_style = ttk.Style()
        self.f1_style.configure('My.TFrame', background='red')
        ...
        self.f2 = ttk.Frame(self.f1, borderwidth=5, relief="sunken", style='My.TFrame', width=200, height=100)
        self.namelbl = ttk.Label(self.f1, text="Name")
        self.name = ttk.Entry(self.f1)
 
        self.onevar = tkinter.BooleanVar()
        self.twovar = tkinter.BooleanVar()
        self.threevar = tkinter.BooleanVar()
        ...
        self.cancel = ttk.Button(self.f1, text="Quit", command=self.on_quit)
    ...
    # Inside the class but not inside init_gui()
    def on_quit(self):
        """Exits program."""
        quit()
